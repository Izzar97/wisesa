...
<head>
  ...
  <link href="{{asset('template')}}/lib/aos/aos.css" rel="stylesheet">
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">WISESA ADI PRAYA</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
       {{--  <a href="#intro"><img src="{{asset('img')}}/logo/logo1.png" rel="icon" alt="" title="" /></img></a> --}}
      </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 about-img" data-aos="fade-left">
                    <img src="{{asset('img')}}/logo/logo1.png" class="img-fluid" alt="logo" width="400" height="250" style="display:block; margin:auto;">
                </div>
            </div>
        </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 features-img">
            <img src="{{asset('template')}}/img/product-features.png" alt="" data-aos="fade-right" data-aos-easing="ease-out-back">
          </div>
    ...
    <section id="advanced-features">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right" src="{{asset('template')}}/img/advanced-feature-1.jpg" alt="" data-aos="fade-left">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right" src="{{asset('template')}}/img/advanced-feature-3.jpg" alt="" data-aos="fade-left">
              <div data-aos="fade-right">
                <h2>Duis aute irure dolor in reprehenderit in voluptate velit esse</h2>
                <h3>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    ...
    <section id="clients">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <img src="{{asset('template')}}/img/clients/client-1.png" alt=""  data-aos="fade-up">
          </div>

          <div class="col-md-2">
            <img src="{{asset('template')}}/img/clients/client-2.png" alt=""  data-aos="fade-up">
          </div>

          <div class="col-md-2">
            <img src="{{asset('template')}}/img/clients/client-3.png" alt=""  data-aos="fade-up">
          </div>

          <div class="col-md-2">
            <img src="{{asset('template')}}/img/clients/client-4.png" alt=""  data-aos="fade-up">
          </div>

          <div class="col-md-2">
            <img src="{{asset('template')}}/img/clients/client-5.png" alt=""  data-aos="fade-up">
          </div>

          <div class="col-md-2">
            <img src="{{asset('template')}}/img/clients/client-6.png" alt=""  data-aos="fade-up">
          </div>
  ...
  <script src="{{asset('template')}}/lib/aos/aos.js"></script>
